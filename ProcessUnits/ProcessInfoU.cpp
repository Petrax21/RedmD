...
if ( PID != 0 ){
        ...
        FormInfm->Memo->Lines->Add("RESERVE         " + IntToStr(MemRES)  + " Pages");
        FormInfm->Memo->Lines->Add("FREE            " + IntToStr(MemFree) + " Pages");
        FormInfm->Memo->Lines->Add("COMMIT          " + IntToStr(MemCom)  + " Pages");
        FormInfm->Memo->Lines->Add("EXECUTE        " + IntToStr(PageEX)  + " Pages");
        FormInfm->Memo->Lines->Add("NOACCESS       " + IntToStr(PageNA)  + " Pages");
        FormInfm->Memo->Lines->Add("READONLY       " + IntToStr(PageR)   + " Pages");
        FormInfm->Memo->Lines->Add("READWRITE      " + IntToStr(PageRW)  + " Pages");
        FormInfm->Memo->Lines->Add("WRITECOPY      " + IntToStr(PageWC)  + " Pages");
